...
contract TestPR16_ZeroRepayment is TestBaseWorkflow, JBTest {
    ...
    function test_repayZeroBoth_reverts() public {
        ...
        // A large donation ensures newBorrowAmount > loan.amount, hitting REVLoans_NewBorrowAmountGreaterThanLoanAmount,
        // OR at exact match, hitting REVLoans_NothingToRepay.
