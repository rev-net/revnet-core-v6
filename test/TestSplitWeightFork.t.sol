...
contract TestSplitWeightFork is TestBaseWorkflow, JBTest {
        ...
        returns (REVConfig memory cfg, JBTerminalConfig[] memory tc, REVSuckerDeploymentConfig memory sdc)
    {
        ...
        sdc = REVSuckerDeploymentConfig({
            ...
            salt: keccak256(abi.encodePacked("FORK_TEST"))
        });
    }
    ...
    function test_fork_swapPath_splitWithBuyback() public onlyFork {
        ...
        console.log("  Swap path: buyback swapped for %s tokens (minting would give 700)", terminalTokensReturned / 1e18);
    }
