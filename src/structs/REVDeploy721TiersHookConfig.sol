...
/// @custom:member preventSplitOperatorAdjustingTiers A flag indicating if the revnet's split operator should be prevented
/// from adding tiers and removing tiers that are allowed to be removed.
/// @custom:member preventSplitOperatorUpdatingMetadata A flag indicating if the revnet's split operator should be prevented
/// from updating the 721's metadata.
...
/// @custom:member preventSplitOperatorIncreasingDiscountPercent A flag indicating if the revnet's split operator should be
/// prevented from increasing the discount of a tier.
