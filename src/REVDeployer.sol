...
contract REVDeployer is ERC2771Context, IREVDeployer, IJBRulesetDataHook, IJBCashOutHook, IERC721Receiver {
        ...
        )
    {
        ...
        // a better price. This is by design — value-based fees would create pool manipulation incentives (an attacker
        // could skew the pool price before cashing out to minimize fees paid).
